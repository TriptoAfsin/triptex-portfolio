...
import { SiFirebase, SiMicrosoftpowerpoint, SiAdobeillustrator, SiFlutter, SiCpanel, SiHtml5, SiCss3, SiJavascript, SiReact} from 'react-icons/si';
...
function Skills() {
    return (
        ...
        <div className="row pad4 center-self hide-on-mobile mt4">
                ...
                <a href="https://reactjs.org/" className="mr1 hide-on-mobile"><SiReact size="48" color="#00dffe"/></a>
